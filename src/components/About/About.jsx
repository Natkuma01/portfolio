...
function About() {
  ...
  <section id="about">
    ...
    <div className='grid grid-flow-row auto-rows-max gap-5 text-slate-50 custom-style'>

    <h1 className="text-2xl text-center">Hi, there</h1>

    <p className="text-base/7">I am dedicated to crafting efficient and user-friendly applications that 
    ...
    <p className="text-base/7">On this website, you will find a collection of my projects, highlighting my 
