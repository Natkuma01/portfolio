...
const images = [
  django, fastapi, html, js, postgreSQL, python, rest, reacts, tailwind, mongodb
];

const Skill = () => {
  return (
    <div className='h-[2000px]'>
      <p className='text-gray-700 text-4xl font-extrabold flex justify-center m-8'>My Skills</p>
