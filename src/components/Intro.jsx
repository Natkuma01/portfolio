    ...
    <div className='flex flex-col md:flex-row p-6 md:p-24'>
      ...
      <div className='flex-1 flex flex-col justify-center md:ml-8 my-8 md:my-0'>
        ...
        <div className='flex justify-center md:justify-start space-x-5'>
          ...
          >
            <img className='max-h-10 md:max-h-12 my-5 rounded-lg' src={linkedinLogo} alt="LinkedIn"/>
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <img className='max-h-10 md:max-h-12 my-5 rounded-lg' src={gitLogo} alt="GitHub"/>
          </a>
        </div>
      </div>
    </div>
