        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="card w-96 shadow-xl m-16">
            <figure>
              <img
                className="h-64"
                src={hungry}
                alt="hungry_rabbit_thumbnail"
              />
            </figure>
            <div className="card-body">
              <div className="flex flex-row">
                <h2 className="card-title basis-2/3 text-gray-700 font-bold">
                  Hungry Rabbit
                </h2>
                <a
              ...
              <p className="text-gray-700">
                A project completed with the Chingu group: a restaurant
                simulator where users can search for restaurants by state and
                category, and use virtual coins to purchase food online.
              </p>
          ...
          <div className="card w-96 shadow-xl m-16">
            ...
            <div className="card-body">
              ...
              <p className="text-gray-700">
                An application that teaches about various types of fish and
                sushi, provides the history of sushi, and includes translations
                for sushi names.
              </p>
              <div className="card-actions justify-end">
                <a
          ...
          <div className="card w-96 shadow-xl m-16">
            ...
            <div className="card-body">
              ...
              <p className="text-gray-700">
                A comprehensive platform for user to explore national parks,
                leave comments and create trip notes
              </p>
              <div className="card-actions justify-end">
                <a
          ...
          <div className="card w-96 shadow-xl m-16">
            ...
            <div className="card-body">
              ...
              <p className="text-gray-700">
                A custom video platform designed with a distinct website layout,
                resembling a personalized version of YouTube.
              </p>
              <div className="card-actions justify-end">
                <a
          ...
          <div className="card w-96 shadow-xl m-16">
            ...
            <div className="card-body">
              ...
              <p className="text-gray-700">
                An interactive platform for food lovers. User can give ratings
                and recipe sharing options
              </p>
              <div className="card-actions justify-end">
                <a
